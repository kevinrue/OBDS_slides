...
1. Construct negative binomial generalised linear model (GLM) for each gene – sequencing depth on x (independent variable), log~10~(UMI count) on y (dependent variable)
