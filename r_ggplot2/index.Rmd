...
- The `r BiocStyle::CRANpkg("renv")` package.
]
...
- In the daily sub-directory of the shared repository, create a sub-directory with your name.

- Copy the subdirectory `r_ggplot2` from the `OBDS_environments` repository to your clone of the shared repository for this course.

- Rename the new sub-directory `r_ggplot2` to your HPC username.

The resulting file structure on your computer should look like the following:

```
  OBDS_Training_May_2021/
  |_ week5/
    |_ day3_ggplot2/
      |_ albrecht (renamed from 'r_ggplot2')
        |_ ... (files)
        |_ r_ggplot2.Rproj
```

- Launch the RStudio project `r_ggplot2.Rproj`.
