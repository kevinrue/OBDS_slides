...
- Open the RStudio project `r_ggplot2` that we created earlier.

**Note:** this project has a project library that contains the package `r BiocStyle::CRANpkg("ggplot2")` and its dependencies.
