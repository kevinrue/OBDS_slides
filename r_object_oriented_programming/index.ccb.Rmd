...
- Make a copy of the file `template.Rmd` for this lesson from the Git repository to your project.
  Use your username to make it unique, e.g

.small-code[

> ```
> cp \
>   /project/obds/$USER/git/week2day2-object_oriented_programming/template.Rmd \
...
> ```
> cp \
>   /project/obds/$USER/git/week2day2-ggplot2/template.Rmd \
