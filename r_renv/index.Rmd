...
- In **Directory name:**, type your GitHub user name (e.g. `kevinrue`).

- In **Create project as subdirectory of :**, click on **Browse** and select the sub-directory `week5/day3_renv` in the shared GitHub repository for this course.
...
<https://kevinushey-2020-rstudio-conf.netlify.app/slides.html> (rstudio::conf 2020)
...
and then *link* the relevant version of each package to the relevant project libraries.
...
**Note:** this installs `r BiocStyle::CRANpkg("renv")` in your _system_ package library, i.e. it is available outside of any project, as soon as you open <i class="fab fa-r-project"></i>.
...
- base packages, in the _system_ library (installed with <i class="fab fa-r-project"></i>).
