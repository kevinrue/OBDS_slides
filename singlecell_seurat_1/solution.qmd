...
```{r}
VlnPlot(seurat_object, c("nCount_RNA", "nFeature_RNA"), layer = "counts")
```
...
VlnPlot(seurat_object, c("nCount_RNA", "nFeature_RNA", "percent_mt"), layer = "counts")
```
...
```{r}
ggplot_counts_raw <- ggplot(FetchData(seurat_after_qc, vars = "LYZ", layer = "counts"), aes(LYZ)) +
    geom_histogram(fill = "grey", color = "black", bins = 100) +
    coord_cartesian(ylim = c(0, 500)) +
    cowplot::theme_cowplot()
ggplot_data_normalised <- ggplot(FetchData(seurat_after_qc, vars = "LYZ", layer = "data"), aes(LYZ)) +
    geom_histogram(fill = "grey", color = "black", bins = 100) +
    coord_cartesian(ylim = c(0, 500)) +
    cowplot::theme_cowplot()
