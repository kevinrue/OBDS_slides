...
> ```
> cp \
>   /project/obds/$USER/projects/bioconductor/bioconductor-kevinrue.Rmd \
>   /project/obds/$USER/git/week3day3-bioconductor/
> ```
]

- Create a new branch in the Git repository.
  Use the date and your username in the branch name to make it unique, e.g. `git checkout -b week3day3-kevinrue`.
