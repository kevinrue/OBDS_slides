...
>   /project/obds/$USER/git/week4day4-emptydroplets_doublets_background/
> ```
]

- Create a new branch in the Git repository.
  Use the date and your username in the branch name to make it unique, e.g. `git checkout -b week4day4-kevinrue`.
