...
- Create and launch a new RStudio project in `/project/obds/$USER/projects/bioconductor_singlecell`.
...
> ```
> cp \
>   /project/obds/$USER/git/week4day3-bioconductor_singlecell/template.Rmd \
>   /project/obds/$USER/projects/bioconductor_singlecell/bioconductor_singlecell-kevinrue.Rmd
> ```
...
The input files obtained from [1k PBMCs from a Healthy Donor (v3 chemistry)](https://www.10xgenomics.com/resources/datasets/1-k-pbm-cs-from-a-healthy-donor-v-3-chemistry-3-standard-3-0-0) are located in `/project/obds/shared/resources/4_r_single_cell/bioconductor_singlecell`.
